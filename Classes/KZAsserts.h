...
#ifndef KZAMakeError
  #define KZAMakeError(message) KZAsserts.errorFunction([NSString stringWithFormat:@"Condition not satisfied: %@", message], KZAssertFailedAssertionCode, @{@"Source" : (id)[NSString stringWithFormat:@"%s:%d", __FILE__, (int)__LINE__], @"Function" : (id)@(__PRETTY_FUNCTION__)}); do{}while(0)
#endif
